...
func (t *Tvm3u) GetTvM3u(c *gin.Context) {
	...
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/m1905/cctv6.m3u8")
	...
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"CCTV16\" tvg-name=\"CCTV16\" tvg-logo=\"https://epg.v1.mk/logo/cctv16.png\" group-title=\"央视\",CCTV-16_4K")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/ysptp/cctv16_4k.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"CCTV4K\" tvg-name=\"CCTV4K\" tvg-logo=\"https://epg.v1.mk/logo/cctv4k.png\" group-title=\"央视\",CCTV-4K")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/ysptp/cctv4k.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"CCTV8K\" tvg-name=\"CCTV8K\" tvg-logo=\"https://epg.v1.mk/logo/cctv8k.png\" group-title=\"央视\",CCTV-8K")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/ysptp/cctv8k_36m.m3u8")

	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"北京卫视\" tvg-name=\"北京卫视\" tvg-logo=\"https://epg.v1.mk/logo/北京卫视4K.png\" group-title=\"北京\",北京卫视4K")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/bjws4k.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV文艺\" tvg-name=\"BTV文艺\" tvg-logo=\"https://epg.v1.mk/logo/北京文艺.png\" group-title=\"北京\",BRTV文艺")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_wy.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV科教\" tvg-name=\"BTV科教\" tvg-logo=\"https://epg.v1.mk/logo/纪实科教.png\" group-title=\"北京\",BRTV纪实科教")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_jskj.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV影视\" tvg-name=\"BTV影视\" tvg-logo=\"https://epg.v1.mk/logo/北京影视.png\" group-title=\"北京\",BRTV影视")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_ys.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV财经\" tvg-name=\"BTV财经\" tvg-logo=\"https://epg.v1.mk/logo/北京财经.png\" group-title=\"北京\",BRTV财经")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_cj.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV体育休闲\" tvg-name=\"BTV体育休闲\" tvg-logo=\"https://epg.v1.mk/logo/北京体育休闲.png\" group-title=\"北京\",BRTV体育休闲")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_tyxx.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV生活\" tvg-name=\"BTV生活\" tvg-logo=\"https://epg.v1.mk/logo/北京生活.png\" group-title=\"北京\",BRTV i生活")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/btrv_ish.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"BTV新闻\" tvg-name=\"BTV新闻\" tvg-logo=\"https://epg.v1.mk/logo/北京新闻.png\" group-title=\"北京\",BRTV新闻")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/brtv_xw.m3u8")
	fmt.Fprintln(c.Writer, "#EXTINF:-1,tvg-id=\"卡酷动画\" tvg-name=\"卡酷动画\" tvg-logo=\"https://epg.v1.mk/logo/北京卡酷少儿.png\" group-title=\"北京\",卡酷少儿")
	fmt.Fprintln(c.Writer, "http://"+c.Request.Host+"/btime/kqsr.m3u8")
